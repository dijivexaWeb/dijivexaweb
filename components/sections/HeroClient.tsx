...
export function HeroClient({ locale, content }: { locale: string; content: HeroContent }) {
  ...
  return (
    ...
    >
      ...
      <motion.div animate={{ scale: [1, 1.2, 1], opacity: [0.08, 0.15, 0.08] }} transition={{ duration: 8, repeat: Infinity, ease: "easeInOut", delay: 2 }}
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-20 lg:py-28">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <motion.div initial={{ opacity: 0, y: 36 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, ease: [0.22, 1, 0.36, 1] }}>
            ...
            <p className="text-lg leading-relaxed mb-8 max-w-xl" style={{ color: "#94A3B8" }}>{content.subheading}</p>
          ...
          <motion.div initial={{ opacity: 0, scale: 0.88, y: 24 }} animate={{ opacity: 1, scale: 1, y: 0 }}
            transition={{ delay: 0.3, duration: 1, ease: [0.22, 1, 0.36, 1] }} style={{ perspective: "1200px" }}>
